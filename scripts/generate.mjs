...
.article-search{grid-template-columns:minmax(260px,.72fr) minmax(420px,1.28fr);gap:42px;align-items:center!important;padding:28px clamp(28px,4.4vw,56px)!important}
.article-search h2{font-size:clamp(28px,2.7vw,36px);line-height:1.12;margin-top:10px!important}
